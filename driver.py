...
statement = ""
if model == '1':
    statement = "mysql+pymysql://root:chicken@127.0.0.1:3306/abac"
elif model == '2':
    statement = "mysql+pymysql://root:chicken@127.0.0.1:3306/rbac"
elif model == '3':
    statement = "mysql+pymysql://root:chicken@127.0.0.1:3306/crbac"
elif model == '4':
    statement = "mysql+pymysql://root:chicken@127.0.0.1:3306/ctrbac"
elif model == '5':
    statement = "mysql+pymysql://root:chicken@127.0.0.1:3306/otabac"
elif model == '6':
    statement = "mysql+pymysql://root:chicken@127.0.0.1:3306/pbac"
...
def checkABAC(listCol):
    ...
    with engine2.connect() as conn:
        ...
        """
        subject = "John"
        environment = "macbook, level 1, asia"
